...
subprojects {
    ...
    cloudstream {
        setRepo("https://github.com/krishbansal-2205/cloudstream-extension")
        authors = listOf("KrishBansal")
    }
    ...
    android {
        ...
        defaultConfig {
            ...
            buildConfigField("String", "SKLIVE_KEY", "\"6c326c356b4237784335715031724b31\"")
            buildConfigField("String", "SKLIVE_IV", "\"70314b356e50377542386848316c3139\"")
            buildConfigField("String", "SKLIVE_V23_KEY", "\"ST00ZGt3UGlPdVJP\"")
            buildConfigField("String", "SKLIVE_V23_IV", "\"d2WT1lR4ckEvUsdk\"")
            buildConfigField("String", "SKLIVE_V25_KEY1", "\"V9LQR42pNKc7smaX\"")
            buildConfigField("String", "SKLIVE_V25_KEY2", "\"d2WT1lR4ckEvUsdk\"")
            buildConfigField("String", "SKLIVE_V25_IV", "\"I=4dkwPiOuROD+pD\"")
            buildConfigField("String", "SKTECH_FIREBASE_API_KEY", "\"AIzaSyClGjK1EBL-ZLbCoep1z5QSmwMyHshimSk\"")
            buildConfigField("String", "SKTECH_FIREBASE_APP_ID", "\"1:330162934410:android:0d81c4732e3d206d6cd373\"")
            buildConfigField("String", "SKTECH_FIREBASE_PROJECT_NUMBER", "\"330162934410\"")
